...
- QUICK_REFERENCE.md
- CHANGELOG.md
- Any user-facing documentation beyond README.md

The skill is for an AI agent to do the job — not for humans to read about it.

### Exception: README.md for Public Repos

If the skill lives in a public repository where humans browse and install skills (e.g., a GitHub skills collection), a README.md is REQUIRED. It should contain: one-line description, feature list, usage table with trigger examples, install command, and license. This is the only user-facing file allowed — keep it concise and factual.
