...
├── README.md          # Required for public repos: human-readable overview
...
- [ ] Step 6: Build Resources
  ...
  - [ ] 6.3 Prepare assets
  - [ ] 6.4 Write README.md ⚠️ REQUIRED for public repos
...
### README.md ⚠️ REQUIRED for public repos

For skills published to a public repository (GitHub, etc.), create a README.md with:
- One-line description
- Feature list
- Usage table with trigger examples
- Install command
- License

Private / AI-only skills can skip this. But if humans will browse the repo to discover skills, README.md is mandatory.
...
- [ ] README.md created if this is a public repo (features, usage, install, license)
...
- Skipping README.md for public repos — humans need docs to discover and install
